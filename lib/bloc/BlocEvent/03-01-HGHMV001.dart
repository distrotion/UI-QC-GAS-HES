...
abstract class HGHMV001_Event {}

class HGHMV001_READ extends HGHMV001_Event {}

class HGHMV001_Bloc extends Bloc<HGHMV001_Event, HGHMV001SCHEMA> {
  HGHMV001_Bloc()
      : super(HGHMV001SCHEMA(
          ItemPick: [''],
    ...
    on<HGHMV001_READ>((event, emit) {
      return _HGHMV001_READ(
          HGHMV001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _HGHMV001_READ(
      HGHMV001SCHEMA toAdd, Emitter<HGHMV001SCHEMA> emit) async {
    //--------------- READ
