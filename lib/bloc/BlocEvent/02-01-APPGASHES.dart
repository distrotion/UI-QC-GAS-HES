...
abstract class APPGASHES_Event {}

class APPGASHES_READ extends APPGASHES_Event {}

class APPGASHES_Bloc extends Bloc<APPGASHES_Event, APPGASHESSCHEMA> {
  APPGASHES_Bloc()
      : super(APPGASHESSCHEMA(
          ItemPick: [''],
    ...
    on<APPGASHES_READ>((event, emit) {
      return _APPGASHES_READ(
          APPGASHESSCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _APPGASHES_READ(
      APPGASHESSCHEMA toAdd, Emitter<APPGASHESSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "APPGASHESdb",
      data: {},
    );
    APPGASHESSCHEMA output = APPGASHESSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
